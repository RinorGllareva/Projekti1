...
<html lang="en">
  ...
  <body>
    ...
    <div class="container2">
      ...
      <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="form" class="form" name="loginForm" onsubmit="return(validateForm())" action="index.html">
          <div class="form-control">
            
            <label for="firstname">Name</label>
            <input required type="text" name="Firstname" placeholder="JohnDoe" id="name" pattern="[a-zA-Z]+" title="The name can only include letters and numbers and is between 3 and 15 characters long" minlength="3" maxlength="15" />
          </div>
          <div class="form-control">
            <label for="Lastname">Lastname</label>
            <input required type="text" name="Lastname" placeholder="JohnDoe" id="username" pattern="[a-zA-Z]+" title="The Lastname can only include letters and numbers and is between 3 and 15 characters long" minlength="3" maxlength="15" />
          </div>
          <div class="form-control">
		...
		<div class="form-control">
          ...
          <input required type="submit" name="registerBtn" id="submitBtn"></button>
        </form>
